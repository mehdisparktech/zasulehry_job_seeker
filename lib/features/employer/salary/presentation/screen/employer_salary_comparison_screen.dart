...
import 'package:zasulehry_job_seeker/features/employer/salary/presentation/controller/employer_salary_comparison_controller.dart';
...
class SalaryComparisonScreen extends StatelessWidget {
  ...
  void _showComparisonResult(
    ...
    SalaryComparisonController controller,
  ) {
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        CommonText(
                          text:
                              '৳ ${controller.salaryDifference.value.toStringAsFixed(0)} higher',
                          fontSize: 16,
                          fontWeight: FontWeight.w500,
                          color: AppColors.white,
                        ),
                        CommonText(
                          text:
                              '${controller.percentageDifference.value.toStringAsFixed(1)}% more',
                          fontSize: 14,
