...
import '../../../../jobseeker/notifications/presentation/screen/notifications_screen.dart';
...
class CreateJobseekerAlertScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final CreateJobseekerAlertController controller = Get.put(CreateJobseekerAlertController());

    return Scaffold(
      backgroundColor: AppColors.background,
      appBar: const CommonAppBar(
        title: 'Create Jobseeker Alert',
      ),
      body: Form(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Obx(() => controller.isPushMessageEnabled.value
                  ? Column(
                children: [
                  Row(
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                color: controller.selectedFrequency.value == frequency
                ...
                children: [
                  Center(
                    child: Checkbox(
                      ...
                      onChanged: (value) => controller.togglePrivacyPolicy(value ?? false),
                      activeColor: AppColors.primaryColor,
