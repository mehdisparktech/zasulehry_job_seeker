...
class _WorkInformationScreenState extends State<WorkInformationScreen> {
  ...
  String? selectedSubCategory = "Software Development";
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              // Category Display
              _buildSectionLabel("Category"),
              _buildInfoDisplay(selectedCategory ?? "Not specified"),

              16.height,

              // Sub Category Display
              _buildSectionLabel("Sub Category"),
              _buildInfoDisplay(selectedSubCategory ?? "Not specified"),
              ...
              _buildSectionLabel("About Myself"),
              _buildInfoDisplay(
                "Experienced software developer with 12 years of expertise in Flutter and mobile app development. Passionate about creating efficient and user-friendly applications.",
                isMultiline: true,
              ),
              ...
              _buildSectionLabel("Work Overview"),
              _buildInfoDisplay(
                "Led development of multiple mobile applications with over 100k downloads. Specialized in performance optimization and cross-platform solutions.",
                isMultiline: true,
              ),
              20.height,
              // Save Button
  ...
  Widget _buildInfoDisplay(String text, {bool isMultiline = false}) {
    return Container(
