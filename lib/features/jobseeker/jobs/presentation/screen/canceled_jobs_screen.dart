...
class CanceledJobsScreen extends StatelessWidget {
  const CanceledJobsScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const CommonAppBar(title: AppString.canceledJobs),
        ...
        child: Padding(
          ...
          child: ListView.separated(
            ...
            itemBuilder: (context, index) => JobCard(
              ...
              onTap: () => Get.to(
                () => ViewJobDetailsScreen(
                  applyJobStatus: ApplyJobStatus.rejected,
                ),
              ),
            ),
